...
```{r download_kaggle_data}

temp <- tempfile(fileext = ".zip")
URL <- "https://www.kaggle.com/datasets/rankirsh/esports-earnings/download?datasetVersionNumber=17"
download.file(url = URL, destfile = temp, method = "curl")
kaggle_data <- unzip(temp, exdir = here::here("data"), list = T)
